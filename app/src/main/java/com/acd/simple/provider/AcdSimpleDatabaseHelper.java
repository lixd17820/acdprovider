...
public class AcdSimpleDatabaseHelper extends SQLiteOpenHelper {

	private static String TAG = "AcdSimpleDatabaseHelper";
	...
	private static AcdSimpleDatabaseHelper mDBConnection;
	 ...
	 * @param version
	 */
	private AcdSimpleDatabaseHelper(Context context, int version) {
		super(context, AcdSimple.DATABASE_NAME, null, version);
	 ...
	 * @return DBAdapter
	 */
	public static synchronized AcdSimpleDatabaseHelper getDBAdapterInstance(
			Context context, int version) {
		if (mDBConnection == null) {
			mDBConnection = new AcdSimpleDatabaseHelper(context, version);
		}
	...
	public void createDataBase() throws IOException {
		...
		if (dbExist) {
			...
			try {
				...
				String myPath = DB_PATH + AcdSimple.DATABASE_NAME;
	...
	private void copyDataBase() throws IOException {
		InputStream myInput = myContext.getAssets().open(
				AcdSimple.DATABASE_NAME);
		File path = new File(DB_PATH);
		if (!path.exists())
			path.mkdirs();
		File outFileName = new File(path, AcdSimple.DATABASE_NAME);
